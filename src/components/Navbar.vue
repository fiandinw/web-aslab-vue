    ...
    >
      ...
      <div class="flex items-center relative">
        ...
        <div class="dropdown relative">
          ...
          >
            <li v-if="!isTodayExist">
              <a
                class="dropdown-item bg-red-600 text-sm py-2 px-4 font-normal block w-full whitespace-nowrap bg-transparent text-white hover:bg-red-400"
        ...
        <ul class="navbar-nav flex flex-col pl-0 list-style-none mr-auto">
          ...
          <li class="nav-item p-2">
            <RouterLink
              class="nav-link text-gray-500 hover:text-gray-700 focus:text-gray-700 p-0"
              to="/admin/kelola"
              >Kelola Akun Asisten</RouterLink
            >
          </li>
          <li class="nav-item p-2">
            <RouterLink
